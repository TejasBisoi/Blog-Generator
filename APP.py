...
from Secret_keys import hugging_face_api_key # Import secret API key from separate file
...
if submit_topic: # Handle button click (submit_topic)
    ...
    st.text(title_suggestion_str.strip()) # Display the generated title suggestions
